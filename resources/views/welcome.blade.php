			...
			<div id="wrapper" class="fade-in">
				...
				<!-- Intro -->
					<div id="intro">
						<h1>Welcome to<br />
						Drummerland</h1>
						<p>A site where a drummer teaches other drummers about drums for <a href="https://www.urbandictionary.com/define.php?term=drummers">drummers</a>.</p>
						<ul class="actions">
				...
				<!-- Header -->
					<header id="header">
						<a href="/" class="logo">Drummerland</a>
					</header>
				...
				<!-- Footer -->
					<footer id="footer">
						...
						<section class="split contact">
							<section class="alt">
								<h3>Address</h3>
								<p>123 Cheap Incorporation St.<br />
								Dover, Delaware 80242</p>
							</section>
							<section>
								<h3>Phone</h3>
								<p><a href="#">(250) 867-5309</a></p>
							</section>
							<section>
								<h3>Email</h3>
								<p><a href="#">justen@halfpackofbadgers.org</a></p>
							</section>
							<section>
								<h3>Social</h3>
								<ul class="icons alt">
